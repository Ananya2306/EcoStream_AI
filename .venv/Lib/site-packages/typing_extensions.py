...
if sys.version_info >= (3, 10):
    def _should_collect_from_parameters(t):
        return isinstance(
            t, (typing._GenericAlias, _types.GenericAlias, _types.UnionType) # type: ignore
        )
else:
    def _should_collect_from_parameters(t):
...
# typing._type_check.
class _SpecialForm(typing._Final, _root=True): # type: ignore
...
class _ExtensionsSpecialForm(typing._SpecialForm, _root=True): # type: ignore
    def __repr__(self):
...
if hasattr(typing, "disjoint_base"):  # 3.15
    disjoint_base = typing.disjoint_base # type: ignore
else:
...
def IntVar(name):
    return typing.TypeVar(name) # type: ignore
...
_overload_dummy = typing._overload_dummy # type: ignore


if hasattr(typing, "get_overloads"):  # 3.11+
    overload = typing.overload
    get_overloads = typing.get_overloads # type: ignore
...
if sys.version_info >= (3, 13, 0, "beta"):
    ...
    class _SpecialGenericAlias(typing._SpecialGenericAlias, _root=True): # type: ignore
...
def _caller(depth=1, default='__main__'):
    try:
        return sys._getframemodulename(depth + 1) or default # type: ignore
...
if sys.version_info >= (3, 13):
    ...
    class _ProtocolMeta(type(typing.Protocol)):
        ...
        def __init__(cls, *args, **kwargs):
            abc.ABCMeta.__init__(cls, *args, **kwargs) # pyright: ignore[reportCallIssue]
        ...
        def __subclasscheck__(cls, other):
            ...
            if (
                ...
                if (
                    ...
                    cls.__non_callable_proto_members__ # type: ignore
    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, *, total=True, closed=None,
            ...
            if _TAKES_MODULE:
                ...
                own_checked_annotations = {
                    n: typing._type_check(tp, msg) # type: ignore
                    for n, tp in own_annotations.items()
                }
            required_keys = set()
            optional_keys = set()
